# أطلس الشيخ زايد — Website

Static website for the **أطلس الشيخ زايد** mobile application.  
Deployed on [Cloudflare Pages](https://pages.cloudflare.com/) at:

> **https://atlas-elsheikh-zayed.pages.dev**
...
website/
  ...
  privacy_policy.html  → Privacy policy (سياسة الخصوصية)
  README.md            → This file
```
...
| Privacy Policy | `/privacy_policy` | Required for Google Play Store submission |
...
| Phone / email | Both `index.html` and `privacy_policy.html` → contact sections |
| Privacy policy date | `privacy_policy.html` → changes section + sidebar footer |
...
- **Privacy Policy URL for Play Store:** `https://atlas-elsheikh-zayed.pages.dev/privacy_policy`

---

© 2026 أطلس الشيخ زايد. All rights reserved.